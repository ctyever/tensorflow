...
model.compile(loss='categorical_crossentropy', optimizer=optimizer, metrics=['acc']) # 다중분류에서 loss 는 categorical_crossentropy
...
hist = model.fit(x_train, y_train, epochs=300, batch_size=512, callbacks=[es, reduce_lr], validation_split=0.25, verbose=2)
...
# reduceLR
# loss :  2.182981014251709
# acc :  0.44269999861717224
