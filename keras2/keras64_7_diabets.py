...
# model2 = build_model()
model2 = KerasRegressor(build_fn=build_model, verbose=1) # , epochs=2, validation_split=0.2) # 한번 랩핑한다
...
# {'batch_size': 50, 'drop': 0.5, 'node1': 64, 'node2': 8}
# -0.0028816273901611567
# 최종 스코어 :  -0.0029238355346024036