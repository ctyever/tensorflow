...
simplernn1 = SimpleRNN(units=32, activation='relu')(input1)
dense1 = Dense(16, activation='relu')(simplernn1)
...
simplernn2 = SimpleRNN(units=32, activation='relu')(input2)
dense11 = Dense(10, activation='relu', name='dense11')(simplernn2)
