...
lastoutput1 = Dense(1, name='lastoutput1')(merge2)
lastoutput2 = Dense(1, name='lastoutput2')(merge2)

model = Model(inputs = [input1, input2], outputs =[lastoutput1, lastoutput2])
