...
#                         filepath='./_save/ModelCheckPoint/keras48_MCP_wine.hdf5')

# model.fit(x_train, y_train, epochs=100, batch_size=8, callbacks=[es, cp], validation_split=0.1, verbose=2)

# model.save('./_save/ModelCheckPoint/keras48_model_wine_save.h5')
# model = load_model('./_save/ModelCheckPoint/keras48_model_wine_save.h5') # save_model
model = load_model('./_save/ModelCheckPoint/keras48_MCP_wine.hdf5') #체크포인트
...
# 체크포인트
# loss :  1.0831713676452637
# accuracy :  0.5428571701049805

# load
# loss :  1.0733387470245361
