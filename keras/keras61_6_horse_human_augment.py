...
# # print(x_train.shape, y_train.shape)  # (451, 150, 150, 3) (451, 2)

# print(y_train.shape, y_test.shape) # (451, 2) (159, 2)

x_train = x_train.reshape(451, 150 * 150 * 3)
x_test = x_test.reshape(159, 150 * 150 * 3)
