...
#                         filepath='./_save/ModelCheckPoint/keras48_MCP_cifar100.hdf5')


# import time
# start_time = time.time()
# model.fit(x_train, y_train, epochs=100, batch_size=150, callbacks=[es, cp], validation_split=0.25, verbose=2)
# end_time = time.time() - start_time

# model.save('./_save/ModelCheckPoint/keras48_model_cifar100_save.h5')
# model = load_model('./_save/ModelCheckPoint/keras48_model_cifar100_save.h5') # save_model
model = load_model('./_save/ModelCheckPoint/keras48_MCP_cifar100.hdf5') #체크포인트
