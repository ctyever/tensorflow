...
model = Sequential()
model.add(Conv2D(filters=100, kernel_size=(2, 2), padding='same', input_shape=(20, 20, 1)))
...
# pca 400 일때 / cnn
# loss :  0.4551555812358856
# accuracy :  0.9580000042915344
# loss :  0.45548418164253235 / scaler = RobustScaler()
