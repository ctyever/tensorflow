...
'malic_acid', 'ash', 'magnesium' 삭제
'''
df = pd.DataFrame(datasets.data, columns=[datasets.feature_names])

df.drop(['malic_acid', 'ash', 'magnesium']  , inplace=True, axis=1)
print(df)
x = df.to_numpy()
...
[178 rows x 10 columns] / 3개 삭제
acc :  0.9814814814814815 / decision
[0.02382358 0.01626976 0.02374506 0.03003649 0.         0.
 0.12477838 0.         0.37054514 0.41080159]
