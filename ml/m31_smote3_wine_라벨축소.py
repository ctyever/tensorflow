...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, train_size=0.5, shuffle=True, random_state=66, stratify=y
)
...
smote = SMOTE(random_state=66, k_neighbors=65)
...
print("model2.score : ", score2)  # model2.score :  0.972972972972973 # model.score :  0.9459459459459459
